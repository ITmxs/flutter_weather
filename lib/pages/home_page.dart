          ...
          child: ListView(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  Observer(
                      builder: (_) => Text('${homePageStore.now?.tmp}',
                          style:
                              TextStyle(fontSize: 140.0, color: Colors.white))),
                  Text('℃',
              ...
              Observer(
                builder: (_) => Row(
                  ...
                  children: <Widget>[
                    Text('${homePageStore.now?.condTxt}',
                        style: TextStyle(fontSize: 32.0, color: Colors.white)),
              ...
              Observer(
                builder: (_) => Row(
                  children: homePageStore.dailyForecastList
                      .map((item) => _threeDayWeather(item))
                      .toList(),
                ),
              ),
              SizedBox(height: 20.0),
              ...
              Container(
                ...
                child: Text(AppLocalizations.of(context).tr('lifestyle'),
              ...
              Observer(
                builder: (_) => GridView.count(
                  ...
                  mainAxisSpacing: 4.0,
                  children: homePageStore.lifeStyleList
                      .where((element) =>
                          homePageStore.lsType[element.type] != null)
                      .map((element) {
                    return Container(
                      decoration: BoxDecoration(
                        color: Color(0x33ffffff),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(homePageStore.lsType[element.type],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text(AppLocalizations.of(context).tr('data_sources'),
                        style: TextStyle(color: Color(0xaac3c3c3))),
                    Text('Luckly_weather',
                        style: TextStyle(color: Color(0xaac3c3c3))),
                  ],
                ),
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context,
                    CupertinoPageRoute(builder: (_) => ChangeLanguagePage()));
              },
            ),
            Divider(height: 0.0),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context,
                    CupertinoPageRoute(builder: (_) => ChangeThemePage()));
              },
            ),
            Divider(height: 0.0),
            ListTile(
